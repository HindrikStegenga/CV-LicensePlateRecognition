...
public class BPN_ImageClassifier_HSV8 : BPN_Classifier {
  ...
  internal BPN_ImageClassifier_HSV8(IntPtr cPtr, bool cMemoryOwn) : base(VisionLabPINVOKE.BPN_ImageClassifier_HSV8_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(BPN_ImageClassifier_HSV8 obj) {
