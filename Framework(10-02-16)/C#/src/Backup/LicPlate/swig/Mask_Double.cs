...
public class Mask_Double : MaskBase {
  ...
  internal Mask_Double(global::System.IntPtr cPtr, bool cMemoryOwn) : base(VisionLabPINVOKE.Mask_Double_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public Mask_Double(int height, int width, int orgX, int orgY) : this(VisionLabPINVOKE.new_Mask_Double__SWIG_4(height, width, orgX, orgY), true) {
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_double tab {
    ...
    get {
      global::System.IntPtr cPtr = VisionLabPINVOKE.Mask_Double_tab_get(swigCPtr);
