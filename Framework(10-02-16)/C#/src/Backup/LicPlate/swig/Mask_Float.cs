...
public class Mask_Float : MaskBase {
  ...
  internal Mask_Float(global::System.IntPtr cPtr, bool cMemoryOwn) : base(VisionLabPINVOKE.Mask_Float_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public Mask_Float(int height, int width, int orgX, int orgY) : this(VisionLabPINVOKE.new_Mask_Float__SWIG_4(height, width, orgX, orgY), true) {
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_float tab {
    ...
    get {
      global::System.IntPtr cPtr = VisionLabPINVOKE.Mask_Float_tab_get(swigCPtr);
